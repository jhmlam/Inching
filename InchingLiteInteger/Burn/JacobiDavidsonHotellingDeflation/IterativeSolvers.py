...
# Body
# =============================
# NOTE  We are grateful to the cupy community for writing down some of the classic solvers.
#       This is copied from 
#       https://github.com/cupy/cupy/blob/v11.3.0/cupyx/scipy/sparse/linalg/_iterative.py#L205
#       to preserve the behaviour only
...
def gmres(A, b, x0=None, tol=1e-5, restart=None, maxiter=None, M=None,
    ...
    while True:
        ...
        ret = numpy.linalg.lstsq(cupy.asnumpy(H), e, rcond=None)
        y = cupy.array(ret[0])
        x += V @ y
        iters += restart
...
def gmresDeflate(A, b, x0=None, uu = None, tol=1e-5, restart=None, maxiter=None, M=None,
          callback=None, atol=None, callback_type=None):
